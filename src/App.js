...
const App = () => {
    ...
    let colorList=["rgb(119, 177, 169)","rgb(22, 160, 133)","rgb(189, 187, 153)","rgb(231, 76, 60)","rgb(39, 174, 96)","rgb(44, 62, 80)","rgb(155, 89, 182)"]
    ...
    <p style={{textAlign:"center", color:"white", fontFamily: 'Raleway'}}>by <a href="https://www.riyadargoub.com" title="Visit my website" style={{textDecoration:"none", color:"white", fontFamily: 'Raleway', fontWeight:"bold"}}>Riyad Argoub</a></p>
        </>
    );
}
